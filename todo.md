...
## Ajuste de Usuário Google (08/11/2025 21:30)

- [x] Remover vínculo Google do usuário israelisd@gmail.com
  - [x] Verificar dados atuais
  - [x] Alterar provider de 'google' para 'email'
  - [x] Limpar openId
  - [x] Confirmar alterações




## Melhorias Admin e Contador (08/11/2025 22:18)

- [x] Permitir admin modificar renderizações dos usuários
  - [x] Adicionar campos editáveis para monthlyQuota e extraRenders
  - [x] Criar endpoint para atualizar valores
  - [x] Adicionar botão salvar na tela de admin
  
- [x] Corrigir inconsistência de valores
  - [x] Verificar cálculo de renderizações disponíveis
  - [x] Adicionar 3 renders gratuitos para plano free
  - [x] Garantir que todas as telas mostram mesmo valor
  
- [x] Adicionar contador no histórico
  - [x] Mostrar renderizações disponíveis na página de histórico
  - [x] Usar mesmo cálculo das outras telas




## Bug: Botão Sair (08/11/2025 22:30)

- [x] Corrigir botão "Sair" que não está funcionando
  - [x] Verificar implementação no Header
  - [x] Verificar hook useAuth
  - [x] Adicionar logs de debug e tratamento robusto de erros
  - [x] Garantir redirecionamento sempre acontece
